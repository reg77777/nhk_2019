...
#define Encoder_DR_A 20 //interrupt 3
#define Encoder_DR_B 24 
#define Encoder_DL_A 19 //interrupt 3
#define Encoder_DL_B 23 
#define Encoder_UL_A 18 //interrupt 5
#define Encoder_UL_B 22 
...
namespace Enc0{
  ...
  ros::Publisher pub("enc0",&pub_msg);
  void publish(){
    pub.publish(&pub_msg); 
  }
...
namespace Enc1{
  ...
  std_msgs::Int16 pub_msg;
  ros::Publisher pub("enc1",&pub_msg);
  void publish(){
    pub.publish(&pub_msg); 
  }
...
namespace Enc2{
  ...
  std_msgs::Int16 pub_msg;
  ros::Publisher pub("enc2",&pub_msg);
  void publish(){
    pub.publish(&pub_msg); 
  }
...
namespace Enc3{
  ...
  std_msgs::Int16 pub_msg;
  ros::Publisher pub("enc3",&pub_msg);
  void publish(){
    pub.publish(&pub_msg); 
  }
